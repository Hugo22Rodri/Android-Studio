      ...
      body: FutureBuilder<Usuario?>(
        ...
        builder: (context, snapshot) {
          ...
          if (usuario == null) {
            ...
            if (authUser != null) {
              usuario = Usuario(id: authUser.id, nombreNegocio: "MI NEGOCIO", correo: authUser.email ?? "");
            }
          }
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: const Color(0xFF2962FF).withOpacity(0.1), blurRadius: 20, offset: const Offset(0, 10)),
                    ],
                  ),
                  child: Column(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0xFFF0F4FF), borderRadius: BorderRadius.circular(30)),
                        child: const Icon(Icons.business_rounded, size: 60, color: Color(0xFF2962FF)),
                      ),
                      const SizedBox(height: 24),
                      Text(
                        usuario?.nombreNegocio.toUpperCase() ?? "CARGANDO...",
                        style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Color(0xFF2962FF)),
                      ),
                ...
                TextButton(
                  ...
                  child: const Text(
                    ...
                    style: TextStyle(color: Color(0xFFF50057), fontWeight: FontWeight.w900, fontSize: 12),
                  ),
                ),
              ],
            ),
...
class _OptionTile extends StatelessWidget {
  ...
  const _OptionTile({required this.icon, required this.title, required this.subtitle, required this.onTap, this.iconColor});
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: (iconColor ?? const Color(0xFF2962FF)).withOpacity(0.1),
